...
SRCS := Main.cpp ShaderProgram.cpp Mesh.cpp Vector3.cpp Camera.cpp Matrix3.cpp AiScene.cpp Transform.cpp KeyBuffer.cpp Matrix4.cpp Texture.cpp VertexBuffer.cpp Scene.cpp IndexBuffer.cpp Model.cpp
